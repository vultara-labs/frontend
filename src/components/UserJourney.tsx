    ...
    return (
        <section id="how-it-works" ref={containerRef} className="py-32 px-6 relative overflow-hidden">
            ...
            <div className="max-w-[1280px] mx-auto flex flex-col gap-24 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 card-solid rounded-[2rem] divide-y md:divide-y-0 md:divide-x divide-white/5 overflow-hidden border border-white/5">
                    {[
                        ...
                        <div key={i} className="p-10 flex flex-col items-center justify-center text-center gap-3 hover:bg-white/[0.02] transition-colors cursor-default group">
                            <span className="text-[var(--volt)] text-4xl font-bold tracking-tighter group-hover:scale-110 transition-transform duration-500">{stat.val}</span>
