                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="px-2 sm:px-3 py-1 rounded-full bg-[var(--success)]/10 border border-[var(--success)]/20 flex items-center gap-1.5 w-fit">
                                                ...
                                                <span className="text-xs sm:text-sm font-bold text-[var(--success)]">~{currentAPY}% APY</span>
                                            </div>
                                            <span className="text-xs text-[var(--text-tertiary)] italic label lowercase">*Variable</span>
                                        </div>
                                    </div>
